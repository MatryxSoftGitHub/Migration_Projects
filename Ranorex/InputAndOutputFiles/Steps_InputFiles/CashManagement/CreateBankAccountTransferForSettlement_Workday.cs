...
namespace Workday_Ranorex.Steps.CashManagement.CreateBankAccountTransferForSettlement
{
    ...
    public class CreateBankAccountTransferForSettlement_Workday : ITestModule
    {
        ...
        void ITestModule.Run()
        {
            ...
            //untTransferForSettlement.TransferPaymentDetails.Txt_Amount.PressKeys("{ControlKey down}{AKey}{ControlKey up}");
            Delay.Seconds(3);
...
//            if (Amount.CompareTo(Amount))
//            {
//                throw new InvalidOperationException("Amount "+Amount+" is equal.");
//            }
//
//            if (this.Amount <= 0)
//            {
//                throw new ArgumentOutOfRangeException("Amount "+Amount+" is not equal.");
//            }

...
public class ProxyAs_Page {
	...
	//Search field
	@FindBy(xpath = "//input[@aria-label='search all of workday']")
	WebElement Txt_WorkdaySearch;

	//Start proxy
	@FindBy(xpath = "//div[contains(text(),'Start Proxy')]")
	WebElement Lnk_StartProxy;
	
	//Stop proxy
		@FindBy(xpath = "//div[contains(text(),'Stop Proxy')]")
		WebElement Lnk_StopProxy;
	
	//Act as
	@FindBy(xpath = "//label[text()='Act As']/parent::div/following-sibling::div//input")
	WebElement Txt_ActAs;
	
	
	//Ok button
	@FindBy(xpath = "//button[@type = 'button' and @role = 'button' and @title = 'OK' and (text() = 'OK' or . = 'OK')]")
	WebElement Btn_Ok;

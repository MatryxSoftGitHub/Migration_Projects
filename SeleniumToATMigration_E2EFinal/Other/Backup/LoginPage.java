...
public class LoginPage
	...
	public LoginPage(WebDriver ldriver)
 {
	...
	//Username
	@FindBy(xpath = "//input[@type = 'text' and @aria-label = 'Username']")
	WebElement sTxt_Username;
	...
	//Sign in Button
	@FindBy(xpath = "//button[(text() = 'Sign In' or . = 'Sign In')]")
	WebElement Btn_SignIn;
	
	
	//Skiplink
	@FindBy(xpath = "//button[text()='Skip' and @data-automation-id=\"linkButton\"]")
	WebElement Lnk_Skip;

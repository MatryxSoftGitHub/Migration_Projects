...
public class CreateAdHocPaymentPage {
	...
	// page----------------------------------------------------------------------------------------------------------------------------------
	// Company
	@FindBy(xpath = "(//label[text()='Company']/parent::div/following-sibling::div//input)") WebElement Txt_Company;

	// Bank Account
	@FindBy(xpath = "(//label[text()='Bank Account']/parent::div/following-sibling::div//input)") WebElement Txt_BankAccount;

	// label payee ---------------------
	@FindBy(xpath = "//label[text()='Payee']/../parent::div//input[@type=\"radio\"]" WebElement Rdo_LabelPayee;

	// Text payee
	@FindBy(xpath = "(//label[text()='Payee']/../parent::div//input)[2]") WebElement Txt_LabelPayee;

	// Currency
	@FindBy(xpath = "(//label[text()=\"Currency\"]/../following-sibling::*//span[@data-automation-id=\"promptIcon\"])[1]" WebElement SpanIconOption;

	// Currency
	@FindBy(xpath = "(//label[text()='Currency']/parent::div/following-sibling::div//input)") WebElement Txt_Currency;

	// Payment Date
	@FindBy(xpath = "(//label[text()='Payment Date']/parent::div/following-sibling::div//input)") WebElement Txt_PaymentDate;

	// Payment Type
	@FindBy(xpath = "(//label[text()='Payment Type']/parent::div/following-sibling::div//input)") WebElement Txt_PaymentType;

	// ControlTotalAmount
	@FindBy(xpath = "//label[text()='Control Total Amount']/parent::div/following-sibling::div//input") WebElement Txt_ControlTotalAmount;

	// Memo
	@FindBy(xpath = "//label[text()='Memo']/parent::div/following-sibling::div//input" WebElement Txt_Memo;

	// text fields of lines tab in ad hoc payment event
	// page----------------------------------------------------------------------------------------------------------------------------------
	// Navigate to lines tab
	@FindBy(xpath = "//*[@data-automation-id=\"tabBar\"]//div[text()='Lines']") WebElement LinesTab;

	// Column line
	@FindBy(xpath = "(//caption[text()='Lines']/following::tbody//td[2]/div)[1]" WebElement ColumnLine;

	// Add Row
	@FindBy(xpath = "//span[text()='Invoice Lines']/ancestor::div[contains(@class,'SuperGrid')]/div//button[not(@data-automation-enabled=\"true\") and  @title=\"Add Row\"]" WebElement AddRow;

	// Add Row
	@FindBy(xpath = "(//td[contains(@headers,\"columnheader3\")]//input)[1]") WebElement Header;

	// Add Row
	@FindBy(xpath = "//span[text()=\"Order\"]/ancestor::td" WebElement TextColmnName;

	// AttachmentsTab
	@FindBy(xpath = "//*[@data-automation-id=\"tabBar\"]//div[text()='Attachments']") WebElement AttachmentsTab;

	// Select Files button
	@FindBy(xpath = "//*[@data-automation-id=\"tabBar\"]//div[text()='Attachments']") WebElement Btn_SelectFiles;

	// upload file
	@FindBy(xpath = "(//input[@type='file'])[last()]") WebElement fileUpload;
